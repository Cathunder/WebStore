...
public class RegisterCashItemDto {
  ...
  public static class Response {
    ...
    public static RegisterCashItemDto.Response from(CashItemEntity cashItemEntity) {
      return RegisterCashItemDto.Response.builder()
